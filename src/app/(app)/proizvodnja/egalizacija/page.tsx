...
import { stornirajEgalizaciju } from "@/modules/proizvodnja/egalizacija-akcije";
import { DugmeStorno } from "@/components/ui/dugme-storno";
              ...
              {dogadjaji.map((d) => (
                <tr key={d.id} className="border-b border-neutral-100 last:border-0 hover:bg-neutral-50">
                  ...
                  <td className="px-4 py-3 text-right">
                    <DugmeStorno akcija={stornirajEgalizaciju.bind(null, d.id)} />
                  </td>
                </tr>
              ))}
            </tbody>
