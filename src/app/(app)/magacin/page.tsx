...
const STATUS_STIL: Record<StatusZaliha, string> = {
  ...
  nisko: "bg-indigo-100 text-indigo-700",
  ...
  return (
    <div>
      <PageHeader
        ...
        akcija={
          upozorenja > 0 ? (
            <span className="inline-flex items-center gap-2 rounded-lg bg-indigo-100 px-3 py-2 text-sm font-medium text-indigo-700">
      ...
      <div className="mb-8 overflow-x-auto rounded-2xl border border-neutral-200 bg-white">
        {proizvodi.length === 0 ? (
                    ...
                    {s.popunjenost != null ? (
                      <div className="flex items-center gap-2">
                        <div className="h-2 w-24 overflow-hidden rounded-full bg-neutral-200">
                          <div className="h-full rounded-full bg-indigo-500" style={{ width: `${s.popunjenost * 100}%` }} />
                        </div>
